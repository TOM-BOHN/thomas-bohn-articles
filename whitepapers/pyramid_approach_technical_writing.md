...
1. **Each Piece Has a Clear Purpose at a Clear Level.** You're not writing "a doc"; you're writing a foundational framework, an artifact, a strategy doc, or a briefing. That choice drives structure and audience.
...
6. **Add Metadata and Structure** (doc type, tags, headings) so agents can navigate the pyramid. That turns your doc set into rich grounding for AI.
