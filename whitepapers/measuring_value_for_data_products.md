...
As the diagram shows, **THS**, **Customer Expertise**, and **Product Adoption** (with **PAD** inside it) are the hidden data products at the bottom of the stack. They drive **CSS**, which surfaces in the **Customer Health Portal** and is one of many offers under the **Premier** or **Signature** Support Plan. Sizing their value effectively, without overclaiming or underclaiming, is what makes the three-way model so critical.
