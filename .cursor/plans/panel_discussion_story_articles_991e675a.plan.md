...
**Output location:** `whitepapers/ground_truth/` — e.g. `gen_ai_agentic_product_engineering.md`, `stakeholder_management_technical_leaders.md`, `experimentation_gtm_data_products.md`, `leading_data_analytics_teams.md`.
...
- **Ground-truth articles (write first):** `whitepapers/ground_truth/` — `gen_ai_agentic_product_engineering.md`, `stakeholder_management_technical_leaders.md`, `experimentation_gtm_data_products.md`, `leading_data_analytics_teams.md`.
