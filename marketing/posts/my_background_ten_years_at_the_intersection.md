# My Background: Ten Years at the Intersection - Marketing Content
...
• Technical excellence and organizational maturity have to advance together. One without the other stalls. That's the through-line across every role
• Operating at the intersection of product, architecture, and delivery isn't a career accident—it's a deliberate positioning toward the hardest and most valuable problems
• The same instincts that built a governance program for 8,000 employees shaped the THS platform on S3, Spark, SageMaker, dbt, and Tableau years later

Back-of-envelope, the data products and platform work I've contributed to across my decade at Salesforce add up to on the order of $100M or more in retained revenue, cost savings, and reduced cost-to-serve. That figure spans every chapter, not any single product.

Written as a window into the arc—for anyone who wants to understand the background behind the work or speak to it clearly in conversation.

Curious how you explain a non-linear career like this? Read the full piece: [See first comment for link]

#AIProductManagement #DataLeadership #TechLeadership #SolutionArchitecture #EngineeringLeadership #Salesforce
...
**Title:** My Background: Ten Years at the Intersection of Product, Architecture, and Engineering

**Subtitle:** A career narrative from BI consulting through AI product leadership at Salesforce—and the through-line that connects it all
